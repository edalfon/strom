...
metrics_df.columns = pd.MultiIndex.from_product(
    [["Single Split"], metrics_df.columns.to_list()]
)

scores_summ.columns = pd.MultiIndex.from_product(
    [["CV"], scores_summ.columns.droplevel(0).to_list()]
)
...
metrics_scores_long["metric"] = (
    metrics_scores_long["metric"].str.split("-").str[0].str.strip()
)
